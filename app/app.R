...
ui <- navbarPage(
    ...
    tabPanel("About",
             ...
             h3("Data sources"),
             p(tags$a(href="https://stats.espncricinfo.com/ci/engine/stats/index.html", "ESPNCricinfo"), "provided all of the data of this project. Specifically, I am indebted to the", tags$a(href="https://cran.r-project.org/web/packages/cricketr/index.html", "cricketr"), "package developed by Tinniam V Ganesh, which made it exceedingly easy to scrape data for players and teams from ESPNCricinfo."),
